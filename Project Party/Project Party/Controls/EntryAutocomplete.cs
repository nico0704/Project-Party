...
namespace EntryAutoComplete
{
    public class EntryAutoComplete : ContentView
    {
        ...
        private void InitGrid()
        {
            ...
            Container.RowDefinitions.Add(new RowDefinition { Height = 42 });
        }
        ...
        private void PlaceControlsInGrid()
        {
            ...
            SearchEntryLayout.RowDefinitions.Add(new RowDefinition { Height = 60 });

            frame = InitSearchEntryLayout();
        ...
        private PancakeView InitSearchEntryLayout()
        {
            var searchEntryLayout = new PancakeView();
            searchEntryLayout.CornerRadius = 10;
            border = new Border();
            border.Color = Color.Black;
            border.Thickness = 1;
            searchEntryLayout.Border = border;

            searchEntryLayout.Content = SearchEntry;
